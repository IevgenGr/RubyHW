...
array_tmp_2 = [621, 445, 147, 159, 430, 222, 482, 44, 194, 522, 652, 494, 14, 126, 532, 387, 441, 471, 337, 446, 18, 36, 202, 574, 556, 458, 16, 139, 222, 220, 107, 82, 264, 366, 501, 319, 314, 430, 55, 336]
p array_tmp_2.delete_if {|el| el.odd?}
...
array_tmp_3 = array
p array_tmp_3.map { |el| el.to_f / 10 }
...
array_tmp_6 = [621, 445, 147, 159, 430, 222, 482, 44, 194, 522, 652, 494, 14, 126, 532, 387, 441, 471, 337, 446, 18, 36, 202, 574, 556, 458, 16, 139, 222, 220, 107, 82, 264, 366, 501, 319, 314, 430, 55, 336]
p array_tmp_6.map { |el| ((el+9).to_s(36)).length<2 ? (el+9).to_s(36) : nil }.compact
